...
export const M        = "var(--rd-metal-base)";
export const MHI      = "var(--rd-metal-hi)";
export const MLO      = "var(--rd-metal-lo)";
export const MT       = "var(--rd-metal-text)";
export const MM       = "var(--rd-metal-muted)";
export const LED_ON   = "var(--rd-led-on)";
export const LED_OFF  = "var(--rd-led-off)";
export const LED_GLOW = "var(--rd-led-glow)";
export const KEY_BG   = "var(--rd-key-bg)";
export const KEY_HI   = "var(--rd-key-hi)";
export const KEY_LO   = "var(--rd-key-lo)";
export const KEY_T    = "var(--rd-key-text)";
export const SEG_FILL = "var(--rd-seg-fill)";
export const SEG_EMPTY= "var(--rd-seg-empty)";
